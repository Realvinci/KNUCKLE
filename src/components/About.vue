<template>
  <section class="section about" id="about" aria-label="about">
       <div class="container">
         <router-link to="/admin" v-if="logged">
           <h1>DashBoard</h1>
         </router-link>
         <h2 class="section-title">Knuckles Store</h2>
         ...
         <div class="about-card">
           <figure class="card-banner img-holder" style="--width: 1170; --height: 450;">
             <img src="../assets/verve.jpg" width="1170" height="450" loading="lazy" alt="Woodex promo"
               class="img-cover">
           </figure>
